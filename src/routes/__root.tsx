...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sakinah — Family Stability" },
      {
        name: "description",
        content:
          "Sakinah is a calm, bilingual family stability companion with knowledge, case studies, and counseling resources.",
      },
      { name: "author", content: "Sakinah" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Noto+Nastaliq+Urdu:wght@400;500;600;700&display=swap",
      },
    ],
  }),
